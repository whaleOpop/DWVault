...
/**
 * CoinVault CoinModel array serializer.
 * 
 * @author BlackWarlow, WhaleOpop
 *
 */
@SerializableAs("CoinVault")
public class CoinVault extends ModelVault<CoinModel> {
	/**
	 * Ctor.
	 * 
	 * @param list List of CoinModel initial models
	 */
	public CoinVault(@Nullable List<CoinModel> list) {
		super(list);
	}
